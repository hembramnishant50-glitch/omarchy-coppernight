...
-- Mac-style bezier curves (easeOutCubic + spring)
...
hl.animation({ leaf = "windowsOut", enabled = true, speed = 4.5, bezier = "macSmoothOut", style = "popin 85%" })
...
hl.animation({ leaf = "fadeOut", enabled = true, speed = 5, bezier = "macSmoothOut" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 5, bezier = "macEase", style = "slidefade 12%" })
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 5, bezier = "macEase", style = "slidefadevert 18%" })
